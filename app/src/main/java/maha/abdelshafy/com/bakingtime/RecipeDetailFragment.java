...
import maha.abdelshafy.com.bakingtime.data.IngredientAdapter;
import maha.abdelshafy.com.bakingtime.data.StepsAdapter;
...
public class RecipeDetailFragment extends android.support.v4.app.Fragment implements StepsAdapter.StepClickHandler {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        addToWidget = (Button) rootView.findViewById(R.id.btn_add_to_widget);
        thumbImage = (ImageView) rootView.findViewById(R.id.iv_thumbnail_description_step);
