...
import maha.abdelshafy.com.bakingtime.data.RecipesAdapter;
import maha.abdelshafy.com.bakingtime.extras.ConnectionDetector;
...
public class RecipesActivity extends AppCompatActivity implements RecipesAdapter.RecipeListOnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        noConnection = (LinearLayout) findViewById(R.id.linearLayout_no_connection);
