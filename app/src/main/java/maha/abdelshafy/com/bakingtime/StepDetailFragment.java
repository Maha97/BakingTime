...
import maha.abdelshafy.com.bakingtime.extras.Extras;
...
public class StepDetailFragment extends android.support.v4.app.Fragment implements ExoPlayer.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        descriptionTitle = (TextView) rootView.findViewById(R.id.tv_title_description_step);
        descriptionStep = (TextView) rootView.findViewById(R.id.tv_description_step);
        mPlayerView = (SimpleExoPlayerView) rootView.findViewById(R.id.video_step_view);
        initializeMediaSession();

        Button previous_step = (Button) rootView.findViewById(R.id.previousStep);
        Button next_step = (Button) rootView.findViewById(R.id.nextStep);
        thumbnail = (ImageView) rootView.findViewById(R.id.iv_thumbnail_description_step);
    ...
    private void playVideo(View rootView) {
        ...
        if (thumbnail != null && !thumbnailUrl.isEmpty()) {
            ImageView thumbnail = (ImageView) rootView.findViewById(R.id.iv_thumbnail_description_step);
            Picasso.with(getContext()).load(thumbnailUrl).into(thumbnail);
        }
        if (videoUrl != null && !videoUrl.isEmpty()) {
